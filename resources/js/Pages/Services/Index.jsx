            ...
            <div className="space-y-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-slate-500">Keep your catalog ready for quotations and invoices.</p>
                    </div>
                    <Link
                ...
                <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <StatCard label="Average price" value={money(stats.avg)} icon="document" />
                </div>
