...
<body>
    <div class="email-container">
        <div class="header">
            <h1>{{ $siteName }}</h1>
            <p>Company Registration Update</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="error-box">
                ...
                <div class="error-text">Company Registration Not Approved</div>
            </div>
            ...
            <div class="message">
                ...
                <p>You may also update your company information and resubmit for approval.</p>
            </div>
        </div>
