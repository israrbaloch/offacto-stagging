        ...
        <div class="content">
            ...
            <div class="status-box {{ $isActive ? 'active' : 'inactive' }}">
                ...
                <div class="status-text">
                    Your company has been {{ $isActive ? 'activated' : 'deactivated' }}
                </div>
            </div>
            ...
            <div class="message">
                @if($isActive)
                    <p>Great news! Your company has been activated. You now have full access to all features for this company.</p>
                    <p>You can manage services, create offers, and send invoices.</p>
                @else
                    <p>Your company has been temporarily deactivated by an administrator.</p>
                    <p>While deactivated, you will not be able to create new offers or invoices for this company.</p>
