<div class="e-modal e-modal--overflow" modal-id="delete-customer">
	...
	<div class="e-modal__wrap">
		...
		<div class="e-modal__modal">
			...
			<div class="e-modal__section">
				<h2 class="e-modal__title">Delete Customer</h2>
			</div>

			<div class="e-modal__section">
				<div class="e-note e-note--error mb-20">
					<p class="e-note__text">
						Are you sure you want to delete the customer "<strong id="delete-customer-name"></strong>"? 
						This action cannot be undone.
					</p>
				</div>

				<form id="delete-customer-form" class="e-form" method="POST">
					@csrf
					@method('DELETE')

					<div class="e-form__submit-wrap mt-20">
						<button type="submit" class="e-form__submit e-button e-button--red">Delete Customer</button>
					</div>
				</form>
			</div>
