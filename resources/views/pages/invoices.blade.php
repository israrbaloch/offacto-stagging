...
@section('content')
	...
	<div class="l-page-header">
		...
		<div class="l-page-header__left-wrap">
			<h1 class="l-page-header__title">Facturen</h1>
			<a class="e-button" href="/factuur-toevoegen">@svg('plus') Factuur toevoegen</a>
		</div>
		...
		<div class="l-page-header__right-wrap">
			...
			<div class="l-page-header__selection-actions">
				<button class="e-button e-button--bordered e-button--purple-dark">Markeer als betaald</button>
		...
		<div class="c-table">
			<div class="c-table__wrap">
				...
				<div class="c-table__tbody">
					...
					<a href="/factuur" class="c-table__tr">
