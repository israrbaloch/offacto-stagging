...
@section('content')
	...
	<div class="l-page-header">
		<div class="l-page-header__left-wrap">
			<h1 class="l-page-header__title">Create Offer</h1>
		</div>
		<div class="l-page-header__right-wrap">
			<div class="l-page-header__right-content">
				...
				<button type="submit" form="create-offer-form" class="e-button">Create Offer</button>
			</div>
		</div>
	</div>

	<div class="l-page-content l-page-content--inline-spacing">
		<form id="create-offer-form" class="e-form" method="POST" action="{{ route('offers.store') }}">
			@csrf

			{{-- Hidden fields for automatic values --}}
			<input type="hidden" name="offer_date" value="{{ now()->format('Y-m-d') }}">
	...
	<script>
		...
		// No existing items for create page
		var existingItems = [];
